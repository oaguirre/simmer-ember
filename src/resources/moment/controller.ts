...
import type { MomentType, MomentTypeEnum } from './model'
import { type UserType, User } from '../user/model'
...
import { getModelProviderForSummary } from '../user/controller'
...
export function extractLevel(levelString: string): string | undefined {
	// format levelString as "strong/mixed/strained/not-observed, one single sentence evidence anchor"
